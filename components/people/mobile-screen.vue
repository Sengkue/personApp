          ...
          <div class="d-flex justify-space-between pa-0 ma-0">
            ...
            >
              ...
              <div class="d-flex justify-end mb-4">
                ...
                <PeopleEdit :item="item" class="ml-3" />
              </div>
            </div>
          </div>
        ...
        <v-expansion-panel-content class="ma-0 pa-0">
          <v-row class="pa-0 ma-0">
            ...
            <v-col cols="12" sm="8" class="pa-0 ma-0">
              <v-row class="pa-0 ma-0">
                <v-col cols="5" class="pa-3 textt">ຊື່:</v-col>
                <v-col cols="7" class="pa-3 text-end">{{ item?.name }}</v-col>
                <v-col cols="12" class="my-0 py-0">
                  <v-divider></v-divider>
                </v-col>
                <v-col cols="5" class="pa-3 textt">ນາມສະກຸນ:</v-col>
                <v-col cols="7" class="pa-3 text-end">{{
                  item?.surname
                }}</v-col>
                <v-col cols="5" class="pa-3 textt">ສະຖານະ:</v-col>
                <v-col cols="7" class="pa-3 text-end">{{ item?.status }}</v-col>

                <v-col cols="5" class="pa-3">ເບີ&ວັອບແອັດ:</v-col>
                <v-col cols="7" class="pa-3 text-end">{{ item?.tel }}</v-col>
                ...
                <v-col
                  :cols="`${item?.detail?.length > 25 ? 12 : 7}`"
                  class="text-end"
                  >{{
