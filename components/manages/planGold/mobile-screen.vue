          ...
          <div class="d-flex justify-space-between pa-0 ma-0">
            ...
            >
              ...
              <div class="d-flex justify-end">
                <managesPlanGoldDelete :item="item?.id" />
                <managesPlanGoldEdit :item="item" />
          ...
          <v-row class="pa-0 ma-0">
            ...
            <v-col cols="12" sm="8" class="pa-0 ma-0">
              <v-row class="pa-0 ma-0">
                ...
                >
                <v-col cols="5" class="pa-3">ເວລາເລີ່ມຕົ້ນ:</v-col>
                <v-col cols="6" class="pa-3">{{
                  formatDateTime(item?.startDate)
                }}</v-col>
                <v-col cols="5" class="pa-3">ເວລາສິ່ນສຸດ:</v-col>
                <v-col cols="6" class="pa-3">{{
                  formatDateTime(item?.endDate ? item?.endDate : "yyyy-MM-dd")
                }}</v-col>
                ...
                <v-col v-if="item?.problem" cols="5" class="pa-3">ບັນຫາ:</v-col>
                <v-col v-if="item?.problem" :cols="`${item?.problem?.length > 25 ? 12 : 6}`">{{
