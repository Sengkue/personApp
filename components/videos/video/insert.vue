<template>
  <div>
    <v-btn fab dark color="green" fixed bottom right @click="openDialog()">
            ...
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" class="py-0">
                  <vue-editor
                    v-model="dataItem.v_description"
  ...
  methods: {
    ...
    async insert() {
      ...
      (this.dataItem.createDate = new Date()),
        ...
        await this.$store.dispatch("videos/addvideos", this.dataItem);
      this.loading = false;
      this.dialog = false;
